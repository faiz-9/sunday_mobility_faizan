...
function Register() {
  ...
  const validateForm = () => {
    ...
    if (typeof userRegistration.name !== "undefined") {
      if (!userRegistration.name.match(/^[a-zA-Z ]*$/)) {
        formIsValid = false;
    ...
    if (typeof userRegistration.mobile !== "undefined") {
      if (!userRegistration.mobile.match(/^[0-9]{10}$/)) {
        formIsValid = false;
        ...
        <div className="contents">
          ...
          <div className="right_wrapper">
            <div className="right_content">
              <h3>Welcome</h3>
              <p id="p">Please register to your account </p>
